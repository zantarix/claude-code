...
Pick whichever level keeps tests close enough to the code they exercise that a reader finds them quickly, without forcing every leaf module to grow its own `tests.rs`.
