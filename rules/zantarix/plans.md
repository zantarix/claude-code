...
* After verification, a plan should explicitly specify to use the `/zantarix:review` skill in order to do a self-review before returning control to the user.
